...
public class MusicAdaper extends RecyclerView.Adapter<MusicAdaper.MyViewHolder> {
    ...
    public MusicAdaper(List<MusicList> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public MusicAdaper.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.music_adapter_layout,null));
    }

    @Override
    public void onBindViewHolder(@NonNull MusicAdaper.MyViewHolder holder,  int position) {
        ...
        String generationDuration =String.format(Locale.getDefault(),"%02d:%02d",
                TimeUnit.MILLISECONDS.toMinutes(Long.parseLong(list2.getDurtion())),
                TimeUnit.MILLISECONDS.toSeconds(Long.parseLong(list2.getDurtion())),
                TimeUnit.MINUTES.toSeconds(TimeUnit.MILLISECONDS.toMinutes(Long.parseLong(list2.getDurtion()))));
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            musicDuration =itemView.findViewById(R.id.musicDurtion);
        }
    }
}
